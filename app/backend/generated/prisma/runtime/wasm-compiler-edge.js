      ...
      indexOf(t, r = null, n = 'utf-8', i = !1) {
        ...
        return (
          ...
          s.length === 0 && i === !1
            ...
            : o(
                (f, T) =>
                  (i ? T <= d : T >= d) && this[T] === s[0] && s.every((A, R) => this[T + R] === A)
              )
        );
      }
...
function np(e, t) {
  ...
  n && (n.removeAllFields(), _s(n, r)),
    t.addErrorMessage(o =>
      i
        ? `The ${o.red('`select`')} statement for type ${o.bold(r.name)} must not be empty. ${er(
            o
          )}`
    ...
    async withRetry(t) {
      for (let r = 0; ; r++) {
        ...
        try {
          ...
          this.logEmitter.emit('warn', {
            message: `Attempt ${r + 1}/${du} failed for ${t.actionGerund}: ${
              i.message ?? '(unknown)'
            }`,
            timestamp: new Date(),
            target: '',
